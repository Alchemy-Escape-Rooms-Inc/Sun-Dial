...
#define DESCRIPTION           "Stateless MQTT bridge for the SunDial puzzle: captures 6 pulse inputs from the Sand Dial Arduino via ISRs and publishes per-symbol true events plus a Wrong event on incorrect guesses; M3 owns dedupe, counting, SOLVED, and the totem trigger"
...
#define PUBLISH_TOPICS        "MermaidsTale/SunDial/status, MermaidsTale/SunDial/log, MermaidsTale/SunDial/Bottle, MermaidsTale/SunDial/Crab, MermaidsTale/SunDial/Turtle, MermaidsTale/SunDial/Coconut, MermaidsTale/SunDial/Trident, MermaidsTale/SunDial/Wrong"
#define SUPPORTED_COMMANDS    "PING, STATUS, RESET, PUZZLE_RESET, CLEAR_STATUS"

// Hardware
#define PIN_CONFIG            "HOUSE_1/Bottle=4, HOUSE_2/Crab=5, HOUSE_3/Turtle=6, HOUSE_4/Coconut=7, HOUSE_5/Trident=15, HOUSE_6/Wrong=16"
#define COMPONENTS            "Level shifter on Sand Dial Arduino HOUSE_1..6 outputs (2s HIGH pulse per correct symbol; HOUSE_6 = 3s pulse per WRONG guess — needs the HOUSE_6/D7 line wired through the shifter to GPIO 16)"
